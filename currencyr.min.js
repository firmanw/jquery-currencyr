...
}b('input[type="checkbox"]',c.elements.remember).unbind().bind("click",function(){c.remember(b(this).attr("checked"),c.elements.currency.text());});},show:function(h){var k=this,e=k.data.base,g=0,f=b(h).offset(),j=b(h).height(),d=k.viewport(),l=k.elements.beak.height()+2,c=(f.top-b(window).scrollTop())+j+l,i=c+k.options.pad;
